...
(run with `lake test` from the repository root), in fourteen suites: the small
...
inline), ten examples re-run at rotation width 37, strict loading, and the
...
The six runtime examples are derived files. Regenerate with
