...
(run with `lake test` from the repository root), in six suites: the small
...
inline), six examples re-run at rotation width 37, strict loading, and the
...
The two runtime examples are derived files. Regenerate with
