...
(run with `lake test` from the repository root), in eight suites: the small
...
inline), seven examples re-run at rotation width 37, strict loading, and the
...
The three runtime examples are derived files. Regenerate with
