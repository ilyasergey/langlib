...
import Langlib.Languages.Subleq.Faithful
...
bytes that invents nothing. See `docs/subleq/computability.md`.
...
instance : TraceLang SubleqLang where
  ...
  trace_faithful := by
    intro p i i' n _ hA hB
    exact Langlib.Subleq.eval_faithful p i i' n hA hB
