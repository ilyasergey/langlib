...
This module proves the halting-answer direction. `Thue.Divergence` proves
exhaustion at every finite fuel on divergent inputs; the public `Thue` module
assembles both fields into `thueComplete`. See `docs/thue/computability.md`.
-/
