...
WTF (Well-Typed Formalism, file extension `.wtf`) is the human-readable
...
restricted fragment of shallowly-embedded Velvet into WTF by relational
...
/-- WTF value types. Integers are unbounded (`Int`); compilers to bounded
...
/-- A WTF program: variable declarations (with optional initialisers,
