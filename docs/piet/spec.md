...
* **In LangLib**:
  ...
  - Turing completeness in [`Langlib/Computability/Piet/Main.lean`](../../Langlib/Computability/Piet/Main.lean) and [docs/piet/computability.md](computability.md), and
...
[`pietComplete`](../../Langlib/Computability/Piet/Main.lean) preserves both halting answers
...
along the two codel geometries `Langlib/Computability/Piet/Main.lean` uses and
